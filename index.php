...
<section id="intro-scrolly">
    <div class="scrolly-window">
        ...
        <div class="scrolly-text-container">
            <div id="step-1" class="scrolly-step-text"><span class="scrolly-label">Tecnología que te Cuida</span>
                <h2 class="scrolly-heading">Lo último en imagen digital <br /><span class="highlight">diseñado para
                        ti</span></h2>
            </div>
            <div id="step-2" class="scrolly-step-text"><span class="scrolly-label">Claridad para tu Sonrisa</span>
                <h2 class="scrolly-heading">Imágenes 3D para que <br /><span class="highlight">veas todo con
                        claridad</span></h2>
            </div>
            <div id="step-3" class="scrolly-step-text"><span class="scrolly-label">Tu Seguridad Primero</span>
                <h2 class="scrolly-heading">Diagnósticos precisos con <br /><span class="highlight">mínima
                        radiación</span></h2>
            </div>
            <div id="step-4" class="scrolly-step-text"><span class="scrolly-label">Confianza Total</span>
                <h2 class="scrolly-heading">El respaldo que tú y <br /><span class="highlight">tu dentista
                        merecen</span></h2>
            </div>
        </div>
    </div>
...
<main class="relative">
    ...
    <section class="w-full pt-32 pb-0">
        <div class="hero-video-container">
            ...
            <div class="hero-text-overlay">
                <span
                    class="hero-anim-item inline-block px-4 py-1.5 mb-6 text-xs font-bold tracking-[0.2em] uppercase bg-cyan-500/10 text-cyan-300 border border-cyan-500/30 rounded-full opacity-0">MÁXIMA
                    TECNOLOGÍA, MÍNIMA RADIACIÓN</span>
                <h1 class="hero-anim-item text-4xl md:text-6xl lg:text-7xl font-light leading-[1.1] mb-6 opacity-0">Tu
                    Salud es Primero. <br><span
                        class="font-normal italic text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 to-white">Tu
                        Sonrisa También.</span></h1>
                <p
                    class="hero-anim-item text-base md:text-lg text-cyan-50/70 max-w-xl mx-auto mb-8 leading-relaxed opacity-0">
                    Imágenes HD con protocolos Ultra Low Dose™. La tecnología más segura para cuidar de ti mientras
                    vemos lo que otros no ven.</p>
    ...
    <section id="estudios" class="max-w-7xl mx-auto pt-10 pb-32 px-4">
        <div class="flex justify-between items-end mb-20">
            <div>
                <span class="text-[10px] font-black tracking-[0.5em] text-cyan-500 uppercase mb-4 block">PORTAFOLIO
                    CLÍNICO</span>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="clinical-card opacity-0 service-reveal">
                <div class="clinical-icon bg-cyan-500/10 text-cyan-600 p-2">
                    <div class="icon-tint"
                        style="-webkit-mask-image: url('img/icons/ortodoncia.png'); mask-image: url('img/icons/ortodoncia.png');">
                    </div>
                </div>
                <h3>Ortodoncia</h3>
                <p>Análisis de alta precisión para tratamientos más rápidos y resultados predecibles.</p>
                <a class="clinical-link" href="estudios.php">Ver estudios <span
                        class="material-symbols-outlined text-sm">arrow_forward</span></a>
            </div>

            <div class="clinical-card service-reveal">
                <div class="clinical-icon bg-blue-500/10 text-blue-600 p-2">
                    <div class="icon-tint"
                        style="-webkit-mask-image: url('img/icons/radiologia.png'); mask-image: url('img/icons/radiologia.png');">
                    </div>
                </div>
                <h3>Radiología 2D</h3>
            ...
            <div class="clinical-card service-reveal">
                <div class="clinical-icon bg-indigo-500/10 text-indigo-600 p-2">
                    <div class="icon-tint"
                        style="-webkit-mask-image: url('img/icons/tomografia.png'); mask-image: url('img/icons/tomografia.png');">
                    </div>
                </div>
                <h3>Tomografía 3D</h3>
            ...
            <div class="clinical-card service-reveal">
                <div class="clinical-icon bg-slate-500/10 text-slate-600 p-2">
                    <div class="icon-tint"
                        style="-webkit-mask-image: url('img/icons/escaneo.png'); mask-image: url('img/icons/escaneo.png');">
                    </div>
                </div>
    ...
    <?php include_once 'includes/trust-section-2.php'; ?>
            ...
            <div class="cta-grid">
                ...
                <div class="lg:pl-12">
                    ...
                    <p class="cta-description">
                        Obtén la nitidez diagnóstica que necesitas con la mínima radiación posible. Descubre por qué
                        miles de pacientes y especialistas confían en nuestra tecnología Ultra Low Dose™.
                    </p>
