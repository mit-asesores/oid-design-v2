        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div class="trust-reveal-left">
                ...
                <div class="mb-12 p-6 bg-white rounded-2xl border-l-4 border-primary shadow-sm">
                    <p class="text-slate-700 italic mb-4">"La tecnología solo es valiosa cuando está al servicio de la
                        salud humana. En OID, garantizamos que cada milímetro de imagen digital salve tiempo y mejore el
                        pronóstico de nuestros pacientes."</p>
                    <div class="flex items-center gap-3">
                        <div class="w-10 h-10 rounded-full bg-slate-200 overflow-hidden">
                            <img src="img/expert_avatar.png" alt="Dr. Arturo Estrada"
                                class="w-full h-full object-cover">
                        </div>
                        <div>
                            <span class="block text-sm font-bold text-slate-900">Dr. Arturo Estrada</span>
                            <span class="block text-[10px] text-primary uppercase tracking-widest">Director Médico
                                OID</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="clinical-card trust-card-interactive trust-reveal-right">
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed font-light">Eliminamos las conjeturas con
                        tomografías de haz cónico que revelan estructuras invisibles, vitales para el éxito de tus
                        implantes y cirugías.</p>
                </div>
                ...
                <div class="clinical-card trust-card-interactive trust-reveal-right" style="transition-delay: 0.1s;">
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed font-light">Cada imagen es validada por radiólogos
                        maxilofaciales certificados. No entregamos fotos, entregamos certezas clínicas.</p>
                </div>
                ...
                <div class="clinical-card trust-card-interactive trust-reveal-right" style="transition-delay: 0.2s;">
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed font-light">Acceso inmediato para tu odontólogo.
                        Sin CD's, sin esperas; tu diagnóstico fluye digitalmente a la consulta en segundos.</p>
                </div>
                ...
                <div class="clinical-card trust-card-interactive trust-reveal-right" style="transition-delay: 0.3s;">
                    ...
                    <p class="text-slate-600 text-sm leading-relaxed font-light">Protocolos Ultra Low Dose™ que reducen
                        drásticamente la radiación, priorizando tu salud sin sacrificar la nitidez diagnóstica.</p>
                </div>
            </div>
